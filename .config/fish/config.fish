...
abbr cfx "$EDITOR ~/.config/X11/xinitrc"
abbr cfX "$EDITOR ~/.config/X11/Xresources"
abbr cfxp "$EDITOR ~/.config/X11/xprofile"
...
alias ref="shortcuts>/dev/null;source $XDG_CONFIG_HOME/shortcutrc;source $XDG_CONFIG_HOME/shell_functions;source $XDG_CONFIG_HOME/aliasrc" 
alias weath="less -S $XDG_DATA_HOME/.local/share/weatherreport" 
